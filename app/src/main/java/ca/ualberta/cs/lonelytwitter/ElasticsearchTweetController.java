...
public class ElasticsearchTweetController {
    ...
    public static class GetTweetsTask extends AsyncTask<String, Void, ArrayList<NormalTweet>> {
        ...
        protected ArrayList<NormalTweet> doInBackground(String... search_parameters) {
            ...
            String search_string2 = "{\"from\":0, \"size\":10000, \"query\": {\"message\": " + search_parameters[0] + "\"}}";

            //each tweet has a message field, the query itself is another json object within this one


            // assume that search_parameters[0] is the only search term we are interested in using
            Search search = new Search.Builder(search_string2)
